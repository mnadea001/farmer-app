<template>
    ...
    >
        ...
        <span
            class="bg-gradient-to-r from-purple-50 to-gray-300 py-2 px-4 w-100 mb-3 rounded-full text-sm hover:from-gray-300 hover:to-purple-50 text-3xl font-semibold float-end"
        >
